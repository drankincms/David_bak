...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms_data/d2/dsperka/8TeV/MakeTBntuples/29Jan/CMSSW_5_3_6/src/UserCode/dsperka/wprimetb/RootFiles_For2DLimits_12Feb_testHFSys/muon_BestJetJet2W_M_WprimeRight_Histos-final_85_140_dr03_lep50.root',include_mc_uncertainties=True)
