...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms_data/d2/dsperka/8TeV/MakeTBntuples/29Jan/CMSSW_5_3_6/src/UserCode/dsperka/wprimetb/RootFiles_For2DLimits_12Feb_finalbins/comb_BestJetJet2W_M_WprimeRight_Histos-final_85_140_dr03_lep50.root',include_mc_uncertainties=True)
    ...
    model.add_lognormal_uncertainty('mulepeff', math.log(1.01), '*','mu_invmass_final')
    model.add_lognormal_uncertainty('muhlteff', math.log(1.01), '*','mu_invmass_final')
...
plot_exp.write_txt('comb_bayesian_limits_expected.txt')
plot_obs.write_txt('comb_bayesian_limits_observed.txt')
