...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms_data/d2/dsperka/8TeV/MakeTBntuples/29Jan/CMSSW_5_3_6/src/UserCode/dsperka/wprimetb/RootFiles_For2DLimits_22Feb/electron_BestJetJet2W_M_WprimeRight_Histos-final_85_140_dr03_lep50.root',include_mc_uncertainties=True)
...
plot_exp, plot_obs = bayesian_limits(model, signal_processes = [['wp900']])
...
#parVals = ml_fit(model, input = 'data', signal_prior = 'flat', signal_processes = [['wp900']], nuisance_constraint = '')
parVals = ml_fit(model, input = 'data', signal_prior = 'flat', nuisance_constraint = '', signal_processes=[['wp900']])
print parVals
