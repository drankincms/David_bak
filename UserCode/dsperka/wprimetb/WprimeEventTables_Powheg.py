...
global txtfile
txtfile = open('eventtables_powheg.txt', 'w') 
...
def FillTables(channel, varName, bin, low, high):
    ...
    if (channel == 'electron'):
        if doqcd == 'True':
            List = ['Data_el','ZJets_M50','WW', 'WJets', 'T_t', 'Tbar_t', 'T_tW', 'Tbar_tW', 'T_s', 'Tbar_s', 'TTbar_Powheg', 'TT_Mtt_700to1000', 'TT_Mtt_1000toInf', 'QCD_Pt_80_170_EM','QCD_Pt_170_250_EM','QCD_Pt_250_350_EM','QCD_Pt_350_EM']
        else:
            List = ['Data_el','ZJets_M50','WW', 'WJets', 'T_t', 'Tbar_t', 'T_tW', 'Tbar_tW', 'T_s', 'Tbar_s', 'TTbar_Powheg', 'TT_Mtt_700to1000', 'TT_Mtt_1000toInf']
    if (channel == 'muon'):
        List = ['Data_mu','ZJets_M50','WW', 'WJets', 'T_t', 'Tbar_t', 'T_tW', 'Tbar_tW', 'T_s', 'Tbar_s', 'TTbar_Powheg', 'TT_Mtt_700to1000', 'TT_Mtt_1000toInf']
    ...
    for cutlabel in CutList:
        ...
        for Type in List:
            ...
            elif Type == 'TTbar_Powheg':
                if (doHighMassTT == 'True'): Trees[Type].Draw(var + " >> " + histName, "("+weight+")*(" + cut + " && genTTMass_WprimeCalc < 700)", 'goff')
                else: Trees[Type].Draw(var + " >> " + histName, "("+weight+")*(" + cut + ")", 'goff')
    ...
    if (doHighMassTT == 'True'):
        EventCountPre['TTbar_Powheg'] += EventCountPre['TT_Mtt_700to1000']
        EventCountPre['TTbar_Powheg'] += EventCountPre['TT_Mtt_1000toInf']
      
        EventCountZero['TTbar_Powheg'] += EventCountZero['TT_Mtt_700to1000']
        EventCountZero['TTbar_Powheg'] += EventCountZero['TT_Mtt_1000toInf']
      
        EventCountOne['TTbar_Powheg'] += EventCountOne['TT_Mtt_700to1000']
        EventCountOne['TTbar_Powheg'] += EventCountOne['TT_Mtt_1000toInf']
      
        EventCountGEOne['TTbar_Powheg'] += EventCountGEOne['TT_Mtt_700to1000']
        EventCountGEOne['TTbar_Powheg'] += EventCountGEOne['TT_Mtt_1000toInf']
      
        EventCountGETwo['TTbar_Powheg'] += EventCountGETwo['TT_Mtt_700to1000']
        EventCountGETwo['TTbar_Powheg'] += EventCountGETwo['TT_Mtt_1000toInf']
      
        EventCountFinal['TTbar_Powheg'] += EventCountFinal['TT_Mtt_700to1000']
        EventCountFinal['TTbar_Powheg'] += EventCountFinal['TT_Mtt_1000toInf']
