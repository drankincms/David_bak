...
def plot_DataVsMc(channel,varName, toppt, j1j2pt, lepjetdR, bin, low, high, ylabel, xlabel, save, wprime, btags, List_to_use):
    ...
    if (channel == 'electron'):      
        cut = 'jet_0_pt_WprimeCalc >= 100 && jet_1_pt_WprimeCalc >= 40 && elec_1_pt_WprimeCalc > 35 && abs(elec_1_eta_WprimeCalc) < 2.5 && elec_1_RelIso_WprimeCalc < 0.1 && corr_met_WprimeCalc > 35 && Muon_DeltaR_LjetsTopoCalcNew > '+lepjetdR
        
    if (channel == 'muon'):      
        cut = 'jet_0_pt_WprimeCalc >= 100 && jet_1_pt_WprimeCalc >= 40 && muon_1_pt_WprimeCalc > 32 && abs(muon_1_eta_WprimeCalc) < 2.1 && muon_1_RelIso_WprimeCalc < 0.12 && corr_met_WprimeCalc > 20 && Muon_DeltaR_LjetsTopoCalcNew > '+lepjetdR
           
    print varName
                 

    if btags == 'zerobtags': cutbtag = ' && ((jet_0_tag_WprimeCalc+jet_1_tag_WprimeCalc)==0) '
    if btags.startswith('onebtags'): cutbtag = ' && ((jet_0_tag_WprimeCalc+jet_1_tag_WprimeCalc)==1) '
    if btags.startswith('twobtags'): cutbtag = ' && ((jet_0_tag_WprimeCalc+jet_1_tag_WprimeCalc)==2) '
    ...
    #weight_ttbarminus = '(weight_TopPt_WprimeCalc*weight_TopPt_WprimeCalc)'
    weight_ttbarplus = '1.0'
    ...
    for Type in List:
        ...
        # Scale W' signal samples to account for taus which aren't included in the generation
        # SF = (2/3)*1.116 
        if (scalefortau and Type.startswith('Wprime')): SF = (2.*1.116)/3.
    ...
    print 'WJets after rescaling: ',VariablesSmoothPre['WJets'].Integral()
    ...
    del VariablesHFup
    del VariablesHFdown
    del VariablesTTbarShapeUp
    del VariablesTTbarShapeDown
    del Variables0tag
    del VariablesSmooth
    del VariablesSmoothPre
    del VariablesSmoothPUup
    del VariablesSmoothHFup
    del VariablesSmoothHFdown
    del VariablesSmoothTTbarShapeUp
    del VariablesSmoothTTbarShapeDown
    del VariablesSmooth0tag
...
# final/onebtags
#if (btags=='final' or btags=='onebtags'): xlow  = [ 100, 300,  400, 500, 600, 700, 800, 900,  1000, 1100, 1200,  1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2200, 4000]
#if (btags=='twobtags'): xlow  = [ 100, 300,  400, 500, 600, 700, 800, 900,  1000, 1100, 1200,  1300, 1400, 1500, 4000]
...
# Just for testing
#xlow  = [ 100, 300,  400, 500, 600, 700, 800, 900,  1000, 1100, 1200,  1300, 1400, 1500, 1700, 4000]
...
#wprime = 'ModRight'
#f = TFile("RootFiles_For2DLimits_23Sep_TEST7TeVcuts/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_7TeVcuts.root","RECREATE")
#f.cd() 
#plot_DataVsMc(channel,var, '75', '100', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgEl_RightWprime) 
...
#f = TFile("RootFiles_For2DLimits_23Sep_TEST7TeVcuts/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_7TeVcuts.root","RECREATE")
#f.cd() 
#plot_DataVsMc(channel,var, '75', '100', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgEl_LeftWprime) 

#wprime = 'Mix'
#f = TFile("RootFiles_For2DLimits_23Sep_TEST7TeVcuts/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_7TeVcuts.root","RECREATE")
#f.cd() 
#plot_DataVsMc(channel,var, '75', '100', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgEl_MixWprime) 
...
#f = TFile("RootFiles_For2DLimits_23Sep_TEST7TeVcuts/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_7TeVcuts.root","RECREATE")
#f.cd() 
#plot_DataVsMc(channel,var, '75', '100', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgMu_RightWprime) 
...
#f = TFile("RootFiles_For2DLimits_23Sep_TEST7TeVcuts/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_7TeVcuts.root","RECREATE")
#f.cd() 
#plot_DataVsMc(channel,var, '75', '100', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgMu_LeftWprime) 

wprime = 'Mix'
f = TFile("RootFiles_For2DLimits_23Sep_TEST7TeVcuts/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_7TeVcuts.root","RECREATE")
f.cd() 
plot_DataVsMc(channel,var, '75', '100', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgMu_MixWprime) 
