...
def plot_DataVsMc(channel,varName, toppt, j1j2pt, lepjetdR, bin, low, high, ylabel, xlabel, save, wprime, btags, List_to_use):
    ...
    if (channel == 'electron'):      
        ...
        cut = 'nSelJets_CommonCalc <= 2 && jet_0_pt_WprimeCalc >= 400 && jet_1_pt_WprimeCalc >= 40 && elec_1_pt_WprimeCalc > 50 && abs(elec_1_eta_WprimeCalc) < 2.5 && elec_1_RelIso_WprimeCalc < 0.1 && corr_met_WprimeCalc > 20 && Muon_DeltaR_LjetsTopoCalcNew > '+lepjetdR
    ...
    if (channel == 'muon'):      
        ...
        cut = 'nSelJets_CommonCalc <= 2 && jet_0_pt_WprimeCalc >= 400 && jet_1_pt_WprimeCalc >= 40 && muon_1_pt_WprimeCalc > 50 && abs(muon_1_eta_WprimeCalc) < 2.1 && muon_1_RelIso_WprimeCalc < 0.12 && corr_met_WprimeCalc > 20 && Muon_DeltaR_LjetsTopoCalcNew > '+lepjetdR
...
#wprime = 'ModRight'
#f = TFile("RootFiles_For2DLimits_23Sep_TESTJet400le2jets/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_85_140_dr03_lep50.root","RECREATE")
#f.cd() 
#plot_DataVsMc(channel,var, '85', '140', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgEl_RightWprime) 

wprime = 'Right'
f = TFile("RootFiles_For2DLimits_23Sep_TESTJet400le2jets_LessBins/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_85_140_dr03_lep50.root","RECREATE")
f.cd() 
plot_DataVsMc(channel,var, '85', '140', '0.3', bins, xlow, high, yaxis, xaxis , save, wprime, btags, List_DataBgEl_RightWprime) 

#wprime = 'Left'
#f = TFile("RootFiles_For2DLimits_18Feb/"+channel+"_"+save+"_Wprime"+wprime+"_Histos-"+btags+"_85_140_dr03_lep50.root","RECREATE")
#f.cd() 
