...
//TLatex *t1temp=0;
 ...
 //latex2->DrawLatex(0.53, 0.25, "e/#mu+jets 95% C.L. Observed");
 latex4->DrawLatex(0.34, 0.19, "e/#mu+jets N_{b tags} = 1 or 2");
 latex4->DrawLatex(0.34, 0.25, "95% CL observed");



c1->Update();
c1->Print("contour_arVSal-combined_observed150_final.pdf");
//c1->Print("contour_arVSal-combined_observed150.C");
c1->Print("contour_arVSal-combined_observed150_final.png");
